...
export type IssueCategory = "schema" | "semantic" | "compatibility" | "security" | "import" | "raw" | "suggestion";
export type Issue = {
...
export type Fingerprint = "chrome" | "firefox" | "safari" | "ios" | "android" | "edge" | "360" | "qq" | "random" | "randomized" | "randomizednoalpn" | "unsafe";
export type Alpn = "h2" | "h3" | "http/1.1";
export type ShadowsocksMethod = "2022-blake3-aes-128-gcm" | "2022-blake3-aes-256-gcm" | "2022-blake3-chacha20-poly1305" | "aes-128-gcm" | "aes-256-gcm" | "chacha20-poly1305" | "chacha20-ietf-poly1305" | "xchacha20-poly1305" | "xchacha20-ietf-poly1305" | "none" | "plain";
...
export type Transport = TcpTransport | GrpcTransport | XHttpTransport | WebSocketTransport | HttpUpgradeTransport | KcpTransport | HysteriaTransport;
...
export type Inbound = VmessInbound | VlessInbound | TrojanInbound | ShadowsocksInbound | HttpInbound | MixedInbound | SocksInbound | WireGuardInbound | HysteriaInbound | DokodemoInbound | TunInbound | UnmanagedInbound;
...
export type OutboundSettings = FreedomOutboundSettings | BlackholeOutboundSettings | DnsOutboundSettings | HttpOutboundSettings | SocksOutboundSettings | ShadowsocksOutboundSettings | VmessOutboundSettings | VlessOutboundSettings | TrojanOutboundSettings | WireGuardOutboundSettings | LoopbackOutboundSettings;
...
export type ProxyOutboundProtocol = "http" | "socks" | "shadowsocks" | "vless" | "vmess" | "trojan" | "hysteria" | "wireguard" | "loopback";
